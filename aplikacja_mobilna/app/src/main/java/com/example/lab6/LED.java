...
public class LED extends AppCompatActivity {
    ...
    // String url = "http://192.168.56.15/led_display.php";  ///< Default IoT server script URL
    String skrypt = "led_display.php";
    String urlText = ipAddress + "/" + skrypt;
    ...
    {
        StringRequest postRequest = new StringRequest(Request.Method.POST, urlText,
                new Response.Listener<String>()
                {
                    @Override
                    public void onResponse(String response) {
